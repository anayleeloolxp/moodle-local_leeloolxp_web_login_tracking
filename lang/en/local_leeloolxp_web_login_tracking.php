...
$string['local_leeloolxp_web_login_trackingdescription'] = '<p>Integrate Leeloo LXP Login and Attendance to your Moodle and track your students login, logout and attendance.</p>';
...
$string['error_message_tracker_stop'] = "Leeloo LXP client didn\'t stop due to a technical issue. Please stop the tracker manually.";
...
$string['web_loginlogoutexplain'] = 'Starts the Leeloo LXP time tracker when a user logs in and stops the tracker when the user logs out.';
...
$string['logout_time_on_activity_help_we'] = "Leeloo LXP will first show the idle time pop-up if no activity is registered, according to Leeloo LXP backend settings.";
